...
function setup() {
  ...
  ground = createSprite(width/2,850,width,125);
  ground.scale = 1.9;
  ...
  invisibleGround = createSprite(width/2,width-135,width,125);
...
function Mount(){
 if (frameCount % 120 === 0){
   var MT = createSprite(900,width-130,width,125);
   MT.addImage(mount3);
...
function spawnAlien(){
 if (frameCount % 250 === 0){
   var alien = createSprite(900,width-180,width,125);
